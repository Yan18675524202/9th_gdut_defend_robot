...
function [u,trajDB] = DynamicWindowApproach(x,model,goal,evalParam,robot_A,robot_B,pos,R,area)
...
[evalDB,trajDB]= Evaluation(x,Vr,goal,robot_A,robot_B,pos ,R,model,evalParam,area);  %evalParam 评价函数参数 [heading,dist,velocity,predictDT]
